<template>
  <div class="setting-container">
    <div class="setting-menu" style="width: 15%">
      ...
      >
        <v-icon size="40"> mdi-numeric-1 </v-icon>
      </v-btn>
      ...
      >
        <v-icon size="40"> mdi-numeric-2 </v-icon>
      </v-btn>
      <hr
        :class="
          model != 0 && model != 1
      ...
      >
        <v-icon size="40"> mdi-numeric-3 </v-icon>
      </v-btn>
      ...
      >
        <v-icon size="40"> mdi-numeric-4 </v-icon>
      </v-btn>
    </div>
    <div style="width: 85%">
      <v-carousel
            ...
            <v-row class="fill-height" align="center">
              ...
              >
                ...
                >
                  ...
                  >
                  <div>
                    <h2 style="color: var(--font-main-color)">SCHEMA 설정</h2>
            ...
            <v-row class="fill-height" align="center">
              <div style="diplay: flex; width: 100%">
                <div style="width: 65%; color: var(--font-sub2-color)">
                  ...
                  <h2 style="color: var(--font-main-color)">수고하셨습니다!</h2>
                  <p style="font-size: 18px; margin-top: 10px">
                    모든 정보 입력을 완료하셨습니다.
                  </p>
                  <p>아래의 버튼을 클릭하시면, 실시간 모니터링이 시작됩니다.</p>
                  <div style="width: 30%">
                    <RealTime />
                  </div>
                  <p style="margin-top: 40px">
